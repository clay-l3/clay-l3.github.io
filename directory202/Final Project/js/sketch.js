...
function setup() {
  ...
  createP('Stroke Color').parent(optionsTitles).style("font-size: 34px");
  createP('Background Color').parent(optionsTitles).style("font-size: 34px");
  createP('Stroke Width').parent(optionsTitles).style("font-size: 34px");
...
// clear button
  clearBut = createButton('Clear Canvas').parent(options).style('width: 100px; background:rgba(25, 135, 84, 0); color: black; border-radius: 20px; font-size: 30px')

// undo button
  undoBut = createButton('Undo').parent(options).style('width: 100px; background: rgba(25, 135, 84, 0); color: black; border-radius: 20px; font-size: 30px')

    // save as PDF button
    savePDFButton = createButton('Save as PDF').parent(options).style('width: 120px; background: rgba(25, 135, 84, 0); color: black; border-radius: 20px; font-size: 30px');
