...
function draw() {
    ...
    circle(450, 410, 29)
    fill("white")
    balloon[1] = quad(465, 320, 435, 320, 435, 410, 465, 410)
    balloon[2] = line(465, 410, 435, 320)
    balloon[3] = line(435, 410, 465, 320)
    fill("red");
    balloon[0] = circle(450, y, 150);
    y -= 1;
    if (y > width - 250) {
        y = 250;
    }
    balloon[5] = line(465, 410, 465, 530)
    fill("black")
    balloon[4] = circle(465, 530, 10)
