...
function setup() {
  ...
  background(30);
  var options = createDiv().style('display: flex; background: #198754; color: white');
  ...
  clearBut = createButton('Clear Canvas').parent(options).style('width: 100px; background: #198754; color: white; border-radius: 20px')
